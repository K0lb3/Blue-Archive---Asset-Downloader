...
class InformationExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = InformationExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsInformationExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.InformationExcel import InformationExcel
...
def InformationExcelTableStart(builder):
...
def InformationExcelTableAddDataList(builder, DataList):
...
def InformationExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def InformationExcelTableEnd(builder):

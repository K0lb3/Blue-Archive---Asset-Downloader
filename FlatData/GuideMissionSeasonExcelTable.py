...
class GuideMissionSeasonExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsGuideMissionSeasonExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.GuideMissionSeasonExcel import GuideMissionSeasonExcel
            obj = GuideMissionSeasonExcel()

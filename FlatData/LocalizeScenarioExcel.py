...
class LocalizeScenarioExcel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = LocalizeScenarioExcel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsLocalizeScenarioExcel(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # LocalizeScenarioExcel
...
def LocalizeScenarioExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddKey(builder, Key): builder.PrependUint32Slot(0, Key, 0)
def LocalizeScenarioExcelAddKey(builder, Key):
...
def LocalizeScenarioExcelAddKr(builder, Kr):
...
def LocalizeScenarioExcelAddJp(builder, Jp):
...
def LocalizeScenarioExcelAddTh(builder, Th):
...
def LocalizeScenarioExcelAddTw(builder, Tw):
...
def LocalizeScenarioExcelAddEn(builder, En):
...
def LocalizeScenarioExcelAddDe(builder, De):

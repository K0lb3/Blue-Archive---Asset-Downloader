...
class ScenarioScriptEvent3Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptEvent3Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptEvent3Excel(cls, buf, offset=0):
...
def ScenarioScriptEvent3ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptEvent3ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptEvent3ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptEvent3ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptEvent3ExcelAddSound(builder, Sound):
...
def ScenarioScriptEvent3ExcelAddTransition(builder, Transition):
...
def ScenarioScriptEvent3ExcelAddBGName(builder, BGName):
...
def ScenarioScriptEvent3ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptEvent3ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptEvent3ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptEvent3ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptEvent3ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptEvent3ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptEvent3ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptEvent3ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptEvent3ExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptEvent3ExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptEvent3ExcelEnd(builder):

...
class BGMUIExcelTable(object):
    ...
    @classmethod
    def GetRootAsBGMUIExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.BGMUIExcel import BGMUIExcel
            obj = BGMUIExcel()
...
def BGMUIExcelTableStart(builder):
...
def BGMUIExcelTableAddDataList(builder, DataList):
...
def BGMUIExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def BGMUIExcelTableEnd(builder):

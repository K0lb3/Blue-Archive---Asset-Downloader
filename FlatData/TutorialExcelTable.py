...
class TutorialExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = TutorialExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsTutorialExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.TutorialExcel import TutorialExcel
            obj = TutorialExcel()
...
def TutorialExcelTableStart(builder):
...
def TutorialExcelTableAddDataList(builder, DataList):
...
def TutorialExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def TutorialExcelTableEnd(builder):

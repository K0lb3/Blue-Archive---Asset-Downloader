...
class ContentsFeverExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsContentsFeverExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.ContentsFeverExcel import ContentsFeverExcel
            obj = ContentsFeverExcel()

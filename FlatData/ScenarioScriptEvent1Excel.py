...
class ScenarioScriptEvent1Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptEvent1Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptEvent1Excel(cls, buf, offset=0):
...
def ScenarioScriptEvent1ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptEvent1ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptEvent1ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptEvent1ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptEvent1ExcelAddSound(builder, Sound):
...
def ScenarioScriptEvent1ExcelAddTransition(builder, Transition):
...
def ScenarioScriptEvent1ExcelAddBGName(builder, BGName):
...
def ScenarioScriptEvent1ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptEvent1ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptEvent1ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptEvent1ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptEvent1ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptEvent1ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptEvent1ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptEvent1ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptEvent1ExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptEvent1ExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptEvent1ExcelEnd(builder):

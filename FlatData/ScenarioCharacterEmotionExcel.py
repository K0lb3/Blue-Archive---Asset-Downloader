...
def AddEmoticonName(builder, EmoticonName): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(EmoticonName), 0)
def ScenarioCharacterEmotionExcelAddEmoticonName(builder, EmoticonName):
    """This method is deprecated. Please switch to AddEmoticonName."""
    return AddEmoticonName(builder, EmoticonName)

...
class LocalizeCodeExcel(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsLocalizeCodeExcel(cls, buf, offset=0):
...
def LocalizeCodeExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddKey(builder, Key): builder.PrependUint32Slot(0, Key, 0)
def LocalizeCodeExcelAddKey(builder, Key):
...
def LocalizeCodeExcelAddKr(builder, Kr):
...
def LocalizeCodeExcelAddJp(builder, Jp):
...
def LocalizeCodeExcelAddTh(builder, Th):
...
def LocalizeCodeExcelAddTw(builder, Tw):
...
def LocalizeCodeExcelAddEn(builder, En):
...
def LocalizeCodeExcelAddDe(builder, De):

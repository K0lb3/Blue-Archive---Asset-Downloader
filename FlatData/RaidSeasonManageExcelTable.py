...
class RaidSeasonManageExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsRaidSeasonManageExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.RaidSeasonManageExcel import RaidSeasonManageExcel

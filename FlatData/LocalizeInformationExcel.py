...
class LocalizeInformationExcel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = LocalizeInformationExcel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsLocalizeInformationExcel(cls, buf, offset=0):
...
def LocalizeInformationExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddKey(builder, Key): builder.PrependUint32Slot(0, Key, 0)
def LocalizeInformationExcelAddKey(builder, Key):
...
def LocalizeInformationExcelAddKr(builder, Kr):
...
def LocalizeInformationExcelAddJp(builder, Jp):
...
def LocalizeInformationExcelAddTh(builder, Th):
...
def LocalizeInformationExcelAddTw(builder, Tw):
...
def LocalizeInformationExcelAddEn(builder, En):
...
def LocalizeInformationExcelAddDe(builder, De):
...
def LocalizeInformationExcelAddFr(builder, Fr):
    """This method is deprecated. Please switch to AddFr."""
    return AddFr(builder, Fr)
def End(builder): return builder.EndObject()
def LocalizeInformationExcelEnd(builder):

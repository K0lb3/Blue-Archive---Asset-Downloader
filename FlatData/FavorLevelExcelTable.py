...
def FavorLevelExcelTableStart(builder):
...
def FavorLevelExcelTableAddDataList(builder, DataList):
...
def FavorLevelExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def FavorLevelExcelTableEnd(builder):

...
class EventContentCharacterBonusExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEventContentCharacterBonusExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.EventContentCharacterBonusExcel import EventContentCharacterBonusExcel
            obj = EventContentCharacterBonusExcel()

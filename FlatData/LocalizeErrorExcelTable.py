...
class LocalizeErrorExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = LocalizeErrorExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsLocalizeErrorExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.LocalizeErrorExcel import LocalizeErrorExcel
...
def LocalizeErrorExcelTableStart(builder):
...
def LocalizeErrorExcelTableAddDataList(builder, DataList):
...
def LocalizeErrorExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def LocalizeErrorExcelTableEnd(builder):

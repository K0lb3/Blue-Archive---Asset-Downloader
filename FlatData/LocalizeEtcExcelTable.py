...
class LocalizeEtcExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = LocalizeEtcExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsLocalizeEtcExcelTable(cls, buf, offset=0):
...
def LocalizeEtcExcelTableStart(builder):
...
def LocalizeEtcExcelTableAddDataList(builder, DataList):
...
def LocalizeEtcExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def LocalizeEtcExcelTableEnd(builder):

...
class MessagePopupExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = MessagePopupExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsMessagePopupExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.MessagePopupExcel import MessagePopupExcel
...
def MessagePopupExcelTableStart(builder):
...
def MessagePopupExcelTableAddDataList(builder, DataList):
...
def MessagePopupExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def MessagePopupExcelTableEnd(builder):

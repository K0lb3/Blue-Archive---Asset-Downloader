...
class GachaElementExcelTable(object):
    ...
    @classmethod
    def GetRootAsGachaElementExcelTable(cls, buf, offset=0):
...
def GachaElementExcelTableStart(builder):
...
def GachaElementExcelTableAddDataList(builder, DataList):
...
def GachaElementExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def GachaElementExcelTableEnd(builder):

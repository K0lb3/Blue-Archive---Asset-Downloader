...
class LocalizeOperatorExcel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = LocalizeOperatorExcel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsLocalizeOperatorExcel(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # LocalizeOperatorExcel
...
def LocalizeOperatorExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddKey(builder, Key): builder.PrependUint32Slot(0, Key, 0)
def LocalizeOperatorExcelAddKey(builder, Key):
...
def LocalizeOperatorExcelAddKr(builder, Kr):
...
def LocalizeOperatorExcelAddJp(builder, Jp):
...
def LocalizeOperatorExcelAddTh(builder, Th):
...
def LocalizeOperatorExcelAddTw(builder, Tw):
...
def LocalizeOperatorExcelAddEn(builder, En):
...
def LocalizeOperatorExcelAddDe(builder, De):

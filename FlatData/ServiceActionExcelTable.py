...
class ServiceActionExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ServiceActionExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsServiceActionExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.ServiceActionExcel import ServiceActionExcel
...
def ServiceActionExcelTableStart(builder):
...
def ServiceActionExcelTableAddDataList(builder, DataList):
...
def ServiceActionExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def ServiceActionExcelTableEnd(builder):

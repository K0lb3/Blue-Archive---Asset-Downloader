...
class EventContentBoxGachaManageExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = EventContentBoxGachaManageExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsEventContentBoxGachaManageExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.EventContentBoxGachaManageExcel import EventContentBoxGachaManageExcel

...
class ScenarioScriptGroup3Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptGroup3Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptGroup3Excel(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # ScenarioScriptGroup3Excel
...
def ScenarioScriptGroup3ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptGroup3ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptGroup3ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptGroup3ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptGroup3ExcelAddSound(builder, Sound):
...
def ScenarioScriptGroup3ExcelAddTransition(builder, Transition):
...
def ScenarioScriptGroup3ExcelAddBGName(builder, BGName):
...
def ScenarioScriptGroup3ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptGroup3ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptGroup3ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptGroup3ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptGroup3ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptGroup3ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptGroup3ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptGroup3ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptGroup3ExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptGroup3ExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptGroup3ExcelEnd(builder):

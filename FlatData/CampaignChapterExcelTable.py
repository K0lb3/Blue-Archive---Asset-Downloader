...
class CampaignChapterExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsCampaignChapterExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.CampaignChapterExcel import CampaignChapterExcel
            obj = CampaignChapterExcel()

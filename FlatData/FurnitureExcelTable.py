...
class FurnitureExcelTable(object):
    ...
    @classmethod
    def GetRootAsFurnitureExcelTable(cls, buf, offset=0):
...
def FurnitureExcelTableStart(builder):
...
def FurnitureExcelTableAddDataList(builder, DataList):
...
def FurnitureExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def FurnitureExcelTableEnd(builder):

...
def GuideMissionExcelTableStart(builder):
...
def GuideMissionExcelTableAddDataList(builder, DataList):
...
def GuideMissionExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def GuideMissionExcelTableEnd(builder):

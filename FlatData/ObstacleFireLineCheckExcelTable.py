...
class ObstacleFireLineCheckExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ObstacleFireLineCheckExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsObstacleFireLineCheckExcelTable(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # ObstacleFireLineCheckExcelTable
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.ObstacleFireLineCheckExcel import ObstacleFireLineCheckExcel
            obj = ObstacleFireLineCheckExcel()

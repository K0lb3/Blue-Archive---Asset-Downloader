...
class SoundUIExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsSoundUIExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.SoundUIExcel import SoundUIExcel
            obj = SoundUIExcel()
...
def SoundUIExcelTableStart(builder):
...
def SoundUIExcelTableAddDataList(builder, DataList):
...
def SoundUIExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def SoundUIExcelTableEnd(builder):

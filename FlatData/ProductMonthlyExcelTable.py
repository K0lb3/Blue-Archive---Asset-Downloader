...
class ProductMonthlyExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsProductMonthlyExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.ProductMonthlyExcel import ProductMonthlyExcel

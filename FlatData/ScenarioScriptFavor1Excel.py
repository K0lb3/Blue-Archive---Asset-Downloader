...
class ScenarioScriptFavor1Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptFavor1Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptFavor1Excel(cls, buf, offset=0):
...
def ScenarioScriptFavor1ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptFavor1ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptFavor1ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptFavor1ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptFavor1ExcelAddSound(builder, Sound):
...
def ScenarioScriptFavor1ExcelAddTransition(builder, Transition):
...
def ScenarioScriptFavor1ExcelAddBGName(builder, BGName):
...
def ScenarioScriptFavor1ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptFavor1ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptFavor1ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptFavor1ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptFavor1ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptFavor1ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptFavor1ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptFavor1ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptFavor1ExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptFavor1ExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptFavor1ExcelEnd(builder):

...
class ScenarioScriptMain3Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptMain3Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptMain3Excel(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # ScenarioScriptMain3Excel
...
def ScenarioScriptMain3ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptMain3ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptMain3ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptMain3ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptMain3ExcelAddSound(builder, Sound):
...
def ScenarioScriptMain3ExcelAddTransition(builder, Transition):
...
def ScenarioScriptMain3ExcelAddBGName(builder, BGName):
...
def ScenarioScriptMain3ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptMain3ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptMain3ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptMain3ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptMain3ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptMain3ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptMain3ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptMain3ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptMain3ExcelAddTextFr(builder, TextFr):

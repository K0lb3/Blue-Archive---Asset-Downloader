...
class BGMRaidExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsBGMRaidExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.BGMRaidExcel import BGMRaidExcel
            obj = BGMRaidExcel()
...
def BGMRaidExcelTableStart(builder):
...
def BGMRaidExcelTableAddDataList(builder, DataList):
...
def BGMRaidExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def BGMRaidExcelTableEnd(builder):

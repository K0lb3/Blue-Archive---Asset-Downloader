...
class ConstCombatExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsConstCombatExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.ConstCombatExcel import ConstCombatExcel
            obj = ConstCombatExcel()

...
class ScenarioScriptFavor2Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptFavor2Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptFavor2Excel(cls, buf, offset=0):
...
def ScenarioScriptFavor2ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptFavor2ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptFavor2ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptFavor2ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptFavor2ExcelAddSound(builder, Sound):
...
def ScenarioScriptFavor2ExcelAddTransition(builder, Transition):
...
def ScenarioScriptFavor2ExcelAddBGName(builder, BGName):
...
def ScenarioScriptFavor2ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptFavor2ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptFavor2ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptFavor2ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptFavor2ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptFavor2ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptFavor2ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptFavor2ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptFavor2ExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptFavor2ExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptFavor2ExcelEnd(builder):

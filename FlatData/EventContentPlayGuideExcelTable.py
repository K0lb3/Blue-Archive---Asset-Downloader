...
class EventContentPlayGuideExcelTable(object):
    ...
    @classmethod
    def GetRootAsEventContentPlayGuideExcelTable(cls, buf, offset=0):
...
def EventContentPlayGuideExcelTableStart(builder):
...
def EventContentPlayGuideExcelTableAddDataList(builder, DataList):
...
def EventContentPlayGuideExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def EventContentPlayGuideExcelTableEnd(builder):

...
class EventContentMissionExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsEventContentMissionExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.EventContentMissionExcel import EventContentMissionExcel
            obj = EventContentMissionExcel()

...
class RaidStageExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsRaidStageExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.RaidStageExcel import RaidStageExcel
            obj = RaidStageExcel()
...
def RaidStageExcelTableStart(builder):
...
def RaidStageExcelTableAddDataList(builder, DataList):
...
def RaidStageExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def RaidStageExcelTableEnd(builder):

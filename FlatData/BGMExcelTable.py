...
class BGMExcelTable(object):
    ...
    @classmethod
    def GetRootAsBGMExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.BGMExcel import BGMExcel
            obj = BGMExcel()
...
def BGMExcelTableStart(builder):
...
def BGMExcelTableAddDataList(builder, DataList):
...
def BGMExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def BGMExcelTableEnd(builder):

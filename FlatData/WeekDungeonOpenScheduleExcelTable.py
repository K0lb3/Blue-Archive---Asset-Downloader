...
class WeekDungeonOpenScheduleExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsWeekDungeonOpenScheduleExcelTable(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # WeekDungeonOpenScheduleExcelTable
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.WeekDungeonOpenScheduleExcel import WeekDungeonOpenScheduleExcel
            obj = WeekDungeonOpenScheduleExcel()

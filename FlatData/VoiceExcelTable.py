...
class VoiceExcelTable(object):
    ...
    @classmethod
    def GetRootAsVoiceExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.VoiceExcel import VoiceExcel
            obj = VoiceExcel()
...
def VoiceExcelTableStart(builder):
...
def VoiceExcelTableAddDataList(builder, DataList):
...
def VoiceExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def VoiceExcelTableEnd(builder):

...
class CafeRankExcelTable(object):
    ...
    @classmethod
    def GetRootAsCafeRankExcelTable(cls, buf, offset=0):
...
def CafeRankExcelTableStart(builder):
...
def CafeRankExcelTableAddDataList(builder, DataList):
...
def CafeRankExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def CafeRankExcelTableEnd(builder):

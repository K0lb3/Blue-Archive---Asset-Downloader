...
class TerrainAdaptationFactorExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsTerrainAdaptationFactorExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.TerrainAdaptationFactorExcel import TerrainAdaptationFactorExcel
            obj = TerrainAdaptationFactorExcel()

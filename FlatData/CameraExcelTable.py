...
class CameraExcelTable(object):
    ...
    @classmethod
    def GetRootAsCameraExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.CameraExcel import CameraExcel
            obj = CameraExcel()
...
def CameraExcelTableStart(builder):
...
def CameraExcelTableAddDataList(builder, DataList):
...
def CameraExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def CameraExcelTableEnd(builder):

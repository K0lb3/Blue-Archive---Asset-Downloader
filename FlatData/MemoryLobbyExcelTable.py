...
class MemoryLobbyExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsMemoryLobbyExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.MemoryLobbyExcel import MemoryLobbyExcel
...
def MemoryLobbyExcelTableStart(builder):
...
def MemoryLobbyExcelTableAddDataList(builder, DataList):
...
def MemoryLobbyExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def MemoryLobbyExcelTableEnd(builder):

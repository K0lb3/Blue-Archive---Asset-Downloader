...
class CharacterCombatSkinExcelTable(object):
    ...
    @classmethod
    def GetRootAsCharacterCombatSkinExcelTable(cls, buf, offset=0):
...
def CharacterCombatSkinExcelTableStart(builder):
...
def CharacterCombatSkinExcelTableAddDataList(builder, DataList):
...
def CharacterCombatSkinExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def CharacterCombatSkinExcelTableEnd(builder):

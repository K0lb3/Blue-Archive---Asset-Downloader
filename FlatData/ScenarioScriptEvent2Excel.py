...
class ScenarioScriptEvent2Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptEvent2Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptEvent2Excel(cls, buf, offset=0):
        """This method is deprecated. Please switch to GetRootAs."""
        return cls.GetRootAs(buf, offset)
    # ScenarioScriptEvent2Excel
...
def ScenarioScriptEvent2ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptEvent2ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptEvent2ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptEvent2ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptEvent2ExcelAddSound(builder, Sound):
...
def ScenarioScriptEvent2ExcelAddTransition(builder, Transition):
...
def ScenarioScriptEvent2ExcelAddBGName(builder, BGName):
...
def ScenarioScriptEvent2ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptEvent2ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptEvent2ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptEvent2ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptEvent2ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptEvent2ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptEvent2ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptEvent2ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptEvent2ExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptEvent2ExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptEvent2ExcelEnd(builder):

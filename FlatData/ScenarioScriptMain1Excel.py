...
class ScenarioScriptMain1Excel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptMain1Excel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptMain1Excel(cls, buf, offset=0):
...
def ScenarioScriptMain1ExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptMain1ExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptMain1ExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptMain1ExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptMain1ExcelAddSound(builder, Sound):
...
def ScenarioScriptMain1ExcelAddTransition(builder, Transition):
...
def ScenarioScriptMain1ExcelAddBGName(builder, BGName):
...
def ScenarioScriptMain1ExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptMain1ExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptMain1ExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptMain1ExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptMain1ExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptMain1ExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptMain1ExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptMain1ExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptMain1ExcelAddTextFr(builder, TextFr):

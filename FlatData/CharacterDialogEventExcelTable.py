...
class CharacterDialogEventExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = CharacterDialogEventExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsCharacterDialogEventExcelTable(cls, buf, offset=0):
...
def CharacterDialogEventExcelTableStart(builder):
...
def CharacterDialogEventExcelTableAddDataList(builder, DataList):
...
def CharacterDialogEventExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def CharacterDialogEventExcelTableEnd(builder):

...
class HpBarAbbreviationExcelTable(object):
    __slots__ = ['_tab']
    ...
    @classmethod
    def GetRootAsHpBarAbbreviationExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            from FlatData.HpBarAbbreviationExcel import HpBarAbbreviationExcel
            obj = HpBarAbbreviationExcel()

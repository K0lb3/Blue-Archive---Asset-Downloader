...
class CharacterDialogExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = CharacterDialogExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsCharacterDialogExcelTable(cls, buf, offset=0):
...
def CharacterDialogExcelTableStart(builder):
...
def CharacterDialogExcelTableAddDataList(builder, DataList):
...
def CharacterDialogExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def CharacterDialogExcelTableEnd(builder):

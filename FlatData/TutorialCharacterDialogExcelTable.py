...
class TutorialCharacterDialogExcelTable(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = TutorialCharacterDialogExcelTable()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsTutorialCharacterDialogExcelTable(cls, buf, offset=0):
    ...
    def DataList(self, j):
        ...
        if o != 0:
            ...
            obj = TutorialCharacterDialogExcel()
...
def TutorialCharacterDialogExcelTableStart(builder):
...
def TutorialCharacterDialogExcelTableAddDataList(builder, DataList):
...
def TutorialCharacterDialogExcelTableStartDataListVector(builder, numElems):
    """This method is deprecated. Please switch to Start."""
    return StartDataListVector(builder, numElems)
def End(builder): return builder.EndObject()
def TutorialCharacterDialogExcelTableEnd(builder):

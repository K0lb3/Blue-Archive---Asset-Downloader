...
class ScenarioScriptContentExcel(object):
    __slots__ = ['_tab']

    @classmethod
    def GetRootAs(cls, buf, offset=0):
        n = flatbuffers.encode.Get(flatbuffers.packer.uoffset, buf, offset)
        x = ScenarioScriptContentExcel()
        x.Init(buf, n + offset)
        return x

    @classmethod
    def GetRootAsScenarioScriptContentExcel(cls, buf, offset=0):
...
def ScenarioScriptContentExcelStart(builder):
    """This method is deprecated. Please switch to Start."""
    return Start(builder)
def AddGroupId(builder, GroupId): builder.PrependInt64Slot(0, GroupId, 0)
def ScenarioScriptContentExcelAddGroupId(builder, GroupId):
...
def ScenarioScriptContentExcelAddSelectionGroup(builder, SelectionGroup):
...
def ScenarioScriptContentExcelAddBGMId(builder, BGMId):
...
def ScenarioScriptContentExcelAddSound(builder, Sound):
...
def ScenarioScriptContentExcelAddTransition(builder, Transition):
...
def ScenarioScriptContentExcelAddBGName(builder, BGName):
...
def ScenarioScriptContentExcelAddBGEffect(builder, BGEffect):
...
def ScenarioScriptContentExcelAddPopupFileName(builder, PopupFileName):
...
def ScenarioScriptContentExcelAddScriptKr(builder, ScriptKr):
...
def ScenarioScriptContentExcelAddTextJp(builder, TextJp):
...
def ScenarioScriptContentExcelAddTextTh(builder, TextTh):
...
def ScenarioScriptContentExcelAddTextTw(builder, TextTw):
...
def ScenarioScriptContentExcelAddTextEn(builder, TextEn):
...
def ScenarioScriptContentExcelAddTextDe(builder, TextDe):
...
def ScenarioScriptContentExcelAddTextFr(builder, TextFr):
...
def ScenarioScriptContentExcelAddVoiceJp(builder, VoiceJp):
    """This method is deprecated. Please switch to AddVoiceJp."""
    return AddVoiceJp(builder, VoiceJp)
def End(builder): return builder.EndObject()
def ScenarioScriptContentExcelEnd(builder):
